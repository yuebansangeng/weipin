          ...
          FlutterError.reportError(
            FlutterErrorDetails(
              exception: FlutterError(
                ...
                'CupertinoDatePickerWeiPin because the parent is too narrow at '
                '${size.width}px.\n'
...
/// Different display modes of [CupertinoDatePickerWeiPin].
///
/// See also:
///
///  * [CupertinoDatePickerWeiPin], the class that implements different display modes
///    of the iOS-style date picker.
///  * [CupertinoPicker], the class that implements a content agnostic spinner UI.
enum CupertinoDatePickerModeWeiPin {
  /// Mode that shows the date in hour, minute, and (optional) an AM/PM designation.
  /// The AM/PM designation is shown only if [CupertinoDatePickerWeiPin] does not use 24h format.
...
// Different types of column in CupertinoDatePickerWeiPin.
...
///
/// There are several modes of the date picker listed in [CupertinoDatePickerModeWeiPin].
///
...
///
/// {@tool dartpad}
/// This sample shows how to implement CupertinoDatePickerWeiPin with different picker modes.
...
///
/// CupertinoDatePickerWeiPin can be displayed directly on a screen or in a popup.
///
...
class CupertinoDatePickerWeiPin extends StatefulWidget {
  /// Constructs an iOS style date picker.
  ///
  /// [mode] is one of the mode listed in [CupertinoDatePickerModeWeiPin] and defaults
  /// to [CupertinoDatePickerModeWeiPin.dateAndTime].
  ///
  /// [onDateTimeChanged] is the callback called when the selected date or time
  /// changes and must not be null. When in [CupertinoDatePickerModeWeiPin.time] mode,
  /// the year, month and day will be the same as [initialDateTime]. When in
  /// [CupertinoDatePickerModeWeiPin.date] mode, this callback will always report the
  ...
  /// In [CupertinoDatePickerModeWeiPin.time] mode, [minimumDate] should typically be
  ...
  /// In [CupertinoDatePickerModeWeiPin.time] mode, [maximumDate] should typically be
  /// on the same date as [initialDateTime], as the picker will not limit the
  ...
  /// [CupertinoDatePickerModeWeiPin.date] mode. Defaults to 1 and must not be null.
  ///
  /// [maximumYear] is the maximum year that the picker can be scrolled to in
  /// [CupertinoDatePickerModeWeiPin.date] mode. Null if there's no limit.
  ///
  ...
  ///
  /// [dateOrder] determines the order of the columns inside [CupertinoDatePickerWeiPin] in date mode.
  /// Defaults to the locale's default date format/order.
  CupertinoDatePickerWeiPin({
    super.key,
    this.mode = CupertinoDatePickerModeWeiPin.dateAndTime,
    ...
    assert(
      mode != CupertinoDatePickerModeWeiPin.dateAndTime ||
          minimumDate == null ||
  ...
  /// The mode of the date picker as one of [CupertinoDatePickerModeWeiPin].
  /// Defaults to [CupertinoDatePickerModeWeiPin.dateAndTime]. Cannot be null and
  /// value cannot change after initial build.
  final CupertinoDatePickerModeWeiPin mode;
  ...
  ///
  /// In [CupertinoDatePickerModeWeiPin.time] mode, a time becomes unselectable if the
  ...
  /// Determines the order of the columns inside [CupertinoDatePickerWeiPin] in date mode.
  /// Defaults to the locale's default date format/order.
  ...
  State<StatefulWidget> createState() {
    ...
    // state.
    switch (mode) {
      case CupertinoDatePickerModeWeiPin.time:
      case CupertinoDatePickerModeWeiPin.dateAndTime:
        return _CupertinoDatePickerWeiPinDateTimeState();
      case CupertinoDatePickerModeWeiPin.date:
        return _CupertinoDatePickerWeiPinDateState(dateOrder: dateOrder);
    }
  }
...
class _CupertinoDatePickerWeiPinDateTimeState
    extends State<CupertinoDatePickerWeiPin> {
  ...
  @override
  void didUpdateWidget(CupertinoDatePickerWeiPin oldWidget) {
  ...
  double _getEstimatedColumnWidth(_PickerColumnType columnType) {
    if (estimatedColumnWidths[columnType.index] == null) {
      estimatedColumnWidths[columnType.index] =
          CupertinoDatePickerWeiPin._getColumnWidth(
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.mode == CupertinoDatePickerModeWeiPin.dateAndTime) {
      if (localizations.datePickerDateTimeOrder ==
              DatePickerDateTimeOrder.time_dayPeriod_date ||
          localizations.datePickerDateTimeOrder ==
...
class _CupertinoDatePickerWeiPinDateState
    extends State<CupertinoDatePickerWeiPin> {
  _CupertinoDatePickerWeiPinDateState({
